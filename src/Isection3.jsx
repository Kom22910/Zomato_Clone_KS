  ...
  return (
    <StrictMode>
      ...
      <div className="col-12">
        ...
        {/* ************************************************ */}
        <div className="col-sm-10 col-11 m-auto p-sm-4 mt-5">
          <p className='fs-sm-1 fs-2 fw-bold'>Corporate announcements</p>
          <hr className='my-sm-5' />


          <div className="col-12 px-sm-1 px-4">
          ...
          <div className="col-sm-6 col-9 my-5 px-sm-1 px-4">
